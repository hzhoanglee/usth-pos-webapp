    ...
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0"
                href=" https://demos.usth.edu.vn/argon-dashboard-pro/pages/dashboards/default.html " target="_blank">
                <img src="../../assets/img/logo-ct-dark.png" class="navbar-brand-img h-100" alt="main_logo">
                <span class="me-1 font-weight-bold">CieloPOS</span>
            </a>
        </div>
                            ...
                            <li class="nav-item ">
                                ...
                                <div class="collapse " id="gettingStartedExample">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://www.usth.edu.vn/learning-lab/bootstrap/quick-start/argon-dashboard"
                                                target="_blank">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://www.usth.edu.vn/learning-lab/bootstrap/license/argon-dashboard"
                                                target="_blank">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://www.usth.edu.vn/learning-lab/bootstrap/overview/argon-dashboard"
                                                target="_blank">
                                                <span class="sidenav-mini-icon text-xs"> C </span>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://www.usth.edu.vn/learning-lab/bootstrap/build-tools/argon-dashboard"
                                                target="_blank">
                                                <span class="sidenav-mini-icon text-xs"> B </span>
                            ...
                            <li class="nav-item ">
                                ...
                                <div class="collapse " id="foundationExample">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://www.usth.edu.vn/learning-lab/bootstrap/colors/argon-dashboard"
                                                target="_blank">
                                                <span class="sidenav-mini-icon text-xs"> C </span>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://www.usth.edu.vn/learning-lab/bootstrap/grid/argon-dashboard"
                                                target="_blank">
                                                <span class="sidenav-mini-icon text-xs"> G </span>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://www.usth.edu.vn/learning-lab/bootstrap/typography/argon-dashboard"
                                                target="_blank">
                                                <span class="sidenav-mini-icon text-xs"> T </span>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link "
                                                href="https://www.usth.edu.vn/learning-lab/bootstrap/icons/argon-dashboard"
                                                target="_blank">
                                                <span class="sidenav-mini-icon text-xs"> I </span>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse " id="componentsExamples">
                        <ul class="nav ms-4">
                            <li class="nav-item ">
                                <a class="nav-link "
                                    href="https://www.usth.edu.vn/learning-lab/bootstrap/alerts/argon-dashboard"
                                    target="_blank">
                                    <span class="sidenav-mini-icon"> A </span>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link "
                                    href="https://www.usth.edu.vn/learning-lab/bootstrap/badge/argon-dashboard"
                                    target="_blank">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link "
                                    href="https://www.usth.edu.vn/learning-lab/bootstrap/buttons/argon-dashboard"
                                    target="_blank">
                                    <span class="sidenav-mini-icon"> B </span>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link "
                                    href="https://www.usth.edu.vn/learning-lab/bootstrap/cards/argon-dashboard"
                                    target="_blank">
                                    <span class="sidenav-mini-icon"> C </span>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link "
                                    href="https://www.usth.edu.vn/learning-lab/bootstrap/carousel/argon-dashboard"
                                    target="_blank">
                                    <span class="sidenav-mini-icon"> C </span>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link "
                                    href="https://www.usth.edu.vn/learning-lab/bootstrap/collapse/argon-dashboard"
                                    target="_blank">
                                    <span class="sidenav-mini-icon"> C </span>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link "
                                    href="https://www.usth.edu.vn/learning-lab/bootstrap/dropdowns/argon-dashboard"
                                    target="_blank">
                                    <span class="sidenav-mini-icon"> D </span>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link "
                                    href="https://www.usth.edu.vn/learning-lab/bootstrap/forms/argon-dashboard"
                                    target="_blank">
                                    <span class="sidenav-mini-icon"> F </span>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link "
                                    href="https://www.usth.edu.vn/learning-lab/bootstrap/modal/argon-dashboard"
                                    target="_blank">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link "
                                    href="https://www.usth.edu.vn/learning-lab/bootstrap/navs/argon-dashboard"
                                    target="_blank">
                                    <span class="sidenav-mini-icon"> N </span>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link "
                                    href="https://www.usth.edu.vn/learning-lab/bootstrap/navbar/argon-dashboard"
                                    target="_blank">
                                    <span class="sidenav-mini-icon"> N </span>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link "
                                    href="https://www.usth.edu.vn/learning-lab/bootstrap/pagination/argon-dashboard"
                                    target="_blank">
                                    <span class="sidenav-mini-icon"> P </span>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link "
                                    href="https://www.usth.edu.vn/learning-lab/bootstrap/popovers/argon-dashboard"
                                    target="_blank">
                                    <span class="sidenav-mini-icon"> P </span>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link "
                                    href="https://www.usth.edu.vn/learning-lab/bootstrap/progress/argon-dashboard"
                                    target="_blank">
                                    <span class="sidenav-mini-icon"> P </span>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link "
                                    href="https://www.usth.edu.vn/learning-lab/bootstrap/spinners/argon-dashboard"
                                    target="_blank">
                                    <span class="sidenav-mini-icon"> S </span>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link "
                                    href="https://www.usth.edu.vn/learning-lab/bootstrap/tables/argon-dashboard"
                                    target="_blank">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link "
                                    href="https://www.usth.edu.vn/learning-lab/bootstrap/tooltips/argon-dashboard"
                                    target="_blank">
                                    <span class="sidenav-mini-icon"> T </span>
        ...
        <div class="sidenav-footer mx-3 my-3">
            ...
            <a href="https://www.usth.edu.vn/learning-lab/bootstrap/overview/argon-dashboard" target="_blank"
                class="btn btn-dark btn-sm w-100 mb-3">توثيق</a>
            <a class="btn btn-primary btn-sm mb-0 w-100"
                href="https://www.usth.edu.vn/product/argon-dashboard?ref=sidebarfree" type="button">التطور
                للاحترافية</a>
        </div>
    </aside>
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-lg-6 mb-lg-0 mb-4">
                            <div class="copyright text-center text-sm text-muted text-lg-end">
                                ...
                                <a href="https://www.usth.edu.vn" class="font-weight-bold" target="_blank">Creative
                                    Tim</a>
                                for a better web.
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                                <li class="nav-item">
                                    <a href="https://www.usth.edu.vn" class="nav-link text-muted"
                                        target="_blank">USTH</a>
                                </li>
                                <li class="nav-item">
                                    <a href="https://www.usth.edu.vn/presentation" class="nav-link text-muted"
                                        target="_blank">About Us</a>
                                </li>
                                <li class="nav-item">
                                    <a href="https://www.usth.edu.vn/blog" class="nav-link text-muted"
                                        target="_blank">Blog</a>
                                </li>
                                <li class="nav-item">
                                    <a href="https://www.usth.edu.vn/license" class="nav-link pe-0 text-muted"
    ...
    <div class="fixed-plugin">
        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body pt-sm-3 pt-0 overflow-auto">
                ...
                <a class="btn btn-primary w-100" href="https://www.usth.edu.vn/product/argon-dashboard-pro-laravel">Buy
                    now</a>
                <a class="btn btn-dark w-100" href="https://www.usth.edu.vn/product/argon-dashboard">Free demo</a>
                <a class="btn bg-gradient-dark w-100" href="https://www.usth.edu.vn/product/argon-dashboard-pro">Free
                    demo</a>
                <a class="btn btn-outline-dark w-100"
                    href="https://www.usth.edu.vn/learning-lab/bootstrap/overview/argon-dashboard">View
                    documentation</a>
                <div class="w-100 text-center">
                    ...
                    <a href="https://twitter.com/intent/tweet?text=Check%20Argon%20Dashboard%20PRO%20made%20by%20%40CreativeTim%20%23webdesign%20%23dashboard%20%23bootstrap5&amp;url=https%3A%2F%2Fwww.usth.edu.vn%2Fproduct%2Fargon-dashboard-pro"
                        class="btn btn-dark mb-0 me-2" target="_blank">
                        <i class="fab fa-twitter me-1" aria-hidden="true"></i> Tweet
                    </a>
                    <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.usth.edu.vn/product/argon-dashboard-pro"
                        class="btn btn-dark mb-0 me-2" target="_blank">
