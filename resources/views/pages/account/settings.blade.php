...
@section('content')
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl ">
        <div class="container-fluid py-1 px-3">
            @include('layouts.navbars.auth.topnav-with-domain', ['domain' => 'Account', 'title' => 'Settings'])
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="ps-5 pt-3 ms-3">
                            <p class="mb-0 text-sm">You haven't added your Slack yet or you aren't authorized.
                                Please add our Slack Bot to your account by clicking on <a href="javascript">here</a>. When
                                you've added the bot, send your verification
                            ...
                            <div class="d-sm-flex bg-gray-100 border-radius-lg p-2 my-4">
                                ...
                                <h6 class="text-sm ms-auto me-3 my-auto">hello@usth.edu.vn</h6>
