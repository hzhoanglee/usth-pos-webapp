                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        ...
                        <ul style="list-style: none;">
                            <li class="text-white text-sm"><strong>admin@pos.vhz.io</strong> with password <strong>secret</strong></li>
                            <li class="text-white text-sm"><strong>creator@pos.vhz.io</strong> with password <strong>secret</strong></li>
                            <li class="text-white text-sm"><strong>member@pos.vhz.io</strong> with password <strong>secret</strong></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            <form role="form" method="POST" action="{{route('login.perform') }}" class="text-start">
                                ...
                                <label>Email</label>
                                <div class="mb-3">
                                    <input type="email" name="email" value="{{ old('email') ?? 'admin@pos.vhz.io' }}" class="form-control" placeholder="Email" aria-label="Email">
