<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-2
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0"
            ...
            <span class="ms-1 font-weight-bold">CieloPOS</span>
        </a>
    </div>
    ...
    <div class="sidenav-footer mx-3 my-3">
        ...
        <a class="btn btn-primary btn-sm mb-0 w-100"
            href="https://www.usth.edu.vn/product/argon-dashboard-pro-laravel" type="button" target="_blank">Upgrade to PRO</a>
    </div>
</aside>
